 ...
 */
public class InsertProcessor extends Thread implements Processor {
    LinkedBlockingQueue<Request> queue = new LinkedBlockingQueue();

    private Processor nextProcesor;

    public InsertProcessor(Processor nextProcesor) {
        super("InsertThread");
    ...
    public void run() {
        while (true) {
            try {
                ...
                System.out.println("insert: " + request.getName());
